...
{
    printf("vous etes sur la case départ");
}
if (monopoly.tabCase[num].nCateg == 1) ///rue
{
    if (monopoly.tabCase[num].hypothequee == 1)
    {
        printf("vous n avez rien à payer ou acheter");
    }
...
{
    printf("vous êtes en prison");
}
if (monopoly.tabCase[num].nCateg == 5) ///tirer une carte caisse de communauté
{
    printf("tirer une carte caisse de communauté");
}
